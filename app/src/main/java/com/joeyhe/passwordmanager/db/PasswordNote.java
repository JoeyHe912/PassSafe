...
public class PasswordNote {
    ...
    @Generated(hash = 328128567)
    public PasswordNote(Long id, @NotNull String name, String webSite, String userName,
                        String password, String note, Date createdDate, Date modifiedDate,
                        Date accessedDate, Boolean notFavorite, Boolean notLetter, String packageName) {
        this.id = id;
        this.name = name;
